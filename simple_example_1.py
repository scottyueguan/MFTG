...
if __name__ == "__main__":
    ...
    if PLOT_VALUE:
        ...
        ax0 = visualize_value(value=data["maxmin_value"][0],
                              blue_mesh=data["mesh_lists"][0][0], red_mesh=data["mesh_lists"][1][0],
        ...
        local_mesh_p, local_mesh_q, value_1_local = solver.construct_value_matrix(blue_RSet_verts=RSet_blue_verts,
                                                                                  red_Reset_verts=RSet_red_verts,
        ...
        ax3.plot([RSet_blue_verts[0], RSet_blue_verts[1], RSet_blue_verts[1], RSet_blue_verts[0], RSet_blue_verts[0]],
                 [RSet_red_verts[1], RSet_red_verts[1], RSet_red_verts[0], RSet_red_verts[0], RSet_red_verts[1]],
    ...
    if PLOT_RSet:
        visualize_blue_Rset(game=example, mu=[p, 1 - p], nu=[q, 1 - q], t=0, visualize=True)
        visualize_red_Rset(game=example, mu=[p, 1 - p], nu=[q, 1 - q], t=0, visualize=True)
