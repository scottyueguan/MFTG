...
if __name__ == "__main__":
    ...
    if PLOT_VALUE:
        ...
        ax1.set_zlabel("$J^{\\rho \star}_{\mathrm{cor}, 1}$", rotation=0, fontsize=label_fontsize)
        ...
        ax2.set_zlabel("$J^{\\rho \star}_{\mathrm{cor}, 2}$", rotation=0, fontsize=label_fontsize)
    ...
    if PLOT_DEVIATE:
        ...
        plt.loglog(np.array(n_blue_list),   np.array(J_N_Opt_list) - np.array(J_N_Opt_blue_list), "bo-",
